...
MED2_WINDOW = 288  # 24h
LONG_WINDOW = 432  # 36h
EMA_FAST = 60  # 5h (slightly shorter for responsiveness)
EMA_SLOW = 240  # 20h
RSI_PERIOD = 60  # 5h
RSI_BULL = 50
RSI_BEAR = 50
...
FUNDING_LOOKBACK = 288  # 24h
FUNDING_BOOST = 0.0
BASE_POSITION_PCT = 0.50
VOL_LOOKBACK = 240  # 20h
TARGET_VOL = 0.015
ATR_LOOKBACK = 120  # 10h (shorter for faster response)
ATR_STOP_MULT = 5.5
